...
import { ContainerLeft, WrapperLeft, Subtitle, ColTwoLeft, Title2 } from "../GloblalElements"
            ...
            <ColTwoLeft>
              ...
              <Theree>
                ...
                >
                    ...
                    <p>colocación de bandejas porta cables, conexión de puesta tierra y montaje eléctrico en general </p>
                </Card>
                <Card
                    as={motion.div}
                    whileHover={{ scale: 1.02 }}
                >
                    ...
                    <h3>ITS medellín</h3>
                    <p>chequeo y conexión de transformadores tipo 1 y tipo2</p>
                </Card>
                <Card
                    as={motion.div}
                    whileHover={{ scale: 1.02 }}
                >
                    ...
                    <p>REPARACION DE MOTORES Y BOMBAS PARA PISCINA Y PLANTAS DE TRATAMIENTO COSTA RICA.</p>
                </Card>
                <Card
                    as={motion.div}
                    whileHover={{ scale: 1.02 }}                
                >
                    ...
                    <p> chequeo y conexion de camaras para trafico, switches de fibras optica</p>
                </Card>
                <Card
                    as={motion.div}
